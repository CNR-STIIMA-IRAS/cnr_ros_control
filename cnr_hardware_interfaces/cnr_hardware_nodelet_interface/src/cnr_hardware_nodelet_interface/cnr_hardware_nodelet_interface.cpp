...
ros::NodeHandle& NodeletManagerInterface::getNamespace       ( ) { return root_nh_; }
std::string      NodeletManagerInterface::loadServiceName    ( ) { return load_  .getService(); }
std::string      NodeletManagerInterface::unloadServiceName  ( ) { return unload_.getService(); }
std::string      NodeletManagerInterface::listServiceName    ( ) { return list_  .getService(); }
